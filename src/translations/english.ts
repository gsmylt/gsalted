...
export const english: Localization = {
  ...
  FEATURE_AREA: {
    ...
    ENCRYPTED: {
      ...
      TEXT:
        'Your secret gets encrypted on client-side before we send it to the cloud.',
    },
    FILES: {
      TITLE: 'Send files',
    ...
    CLEAN_UP: {
      ...
      TEXT:
        'Your secret will be deleted after 24 hours (we keep it up to 30 days if you really want).',
    },
    LIKE: {
      TITLE: 'Simple. Fun. Secure. Free.',
      TEXT:
        'There are a lot of things you will like about gsalted - just try it out, it’s free.',
    },
  },
  ...
  SECRET_CREATION: {
    ...
    KEY_STEP: {
      ...
      DESCRIPTION:
        'The key is used to encrypt your secret (along with a generated random key, but don\'t care about that). It should be as long as possible but easy to remember. You\'ll have to send it to your friend.',
      NEXT: 'Next',
      FIELDS: {
    ...
    MAGIC_STEP: {
      TITLE: 'Do the magic',
      DESCRIPTION:
        'Are you ready to share your secret? We\'ll encrypt your secret and upload it into the cloud <i class="bx bx-cloud"></i>. We then provide you a unique link that you can share with your buddy.',
    ...
    SECRET_STEP: {
      TITLE: 'Your secret',
      DESCRIPTION:
        'The secret is what you want to share with your buddy, be it a password or something else. Use the password we generated for you or enter your own.',
      FIELDS: {
    ...
    SHARE_STEP: {
      ...
      DESCRIPTION:
        'Yeah! We have encrypted your secret. Send the share link and your encryption key to your buddy. Please use two different mediums (e.g. e-mail and iMessage) to send them.',
      FIELDS: {
      ...
      ACTIONS: {
        ...
        MAILTO_LINK:
          'mailto:?subject=gsalted&body=Hi%2C%0A%0AI%20want%20to%20share%20a%20secret%20with%20you%3A%0A{link}',
      },
  ...
  SECRET_RECEIVING: {
    ...
    KEY_STEP: {
      ...
      DESCRIPTION:
        'The key will be needed to decrypt the secret. Please ask your friend if you have not received the key. The secret cannot be decrypted without the key.',
      FIELDS: {
